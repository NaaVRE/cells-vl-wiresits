...
raw_vector_data_in_batches <- list()
raw_vector_data_in_batches <- split_into_batches(raw_vector_data, param_number_of_batches)
# capturing outputs
print('Serialization of raw_vector_data_in_batches')
file <- file(paste0('/tmp/raw_vector_data_in_batches_', id, '.json'))
writeLines(toJSON(raw_vector_data_in_batches, auto_unbox=TRUE), file)
close(file)
