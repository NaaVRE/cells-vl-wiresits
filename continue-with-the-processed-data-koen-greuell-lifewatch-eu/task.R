...
print("Retrieving processed_c_data")
var = opt$processed_c_data
print(var)
var_len = length(var)
print(paste("Variable processed_c_data has length", var_len))

print("------------------------Running var_serialization for processed_c_data-----------------------")
print(opt$processed_c_data)
