...
result <- list()
result <- purrr::map(raw_vector_data, perform_calculation)
# capturing outputs
print('Serialization of result')
file <- file(paste0('/tmp/result_', id, '.json'))
writeLines(toJSON(result, auto_unbox=TRUE), file)
close(file)
